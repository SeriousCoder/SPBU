...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/stackcalc.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/stackcalc.exe: ${OBJECTFILES}
...
${OBJECTDIR}/main.o: main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -IList.h -include List.h -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/stackcalc.exe
